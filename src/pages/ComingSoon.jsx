    ...
    <div>
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          ...
          At OGTechCommunity, we're a dynamic team of passionate tech enthusiasts dedicated to driving tech innovations forward. Our mission is to create a supportive and collaborative platform where tech bros can come together to explore cutting-edge technologies, share ideas, and turn their visions into reality.
          </p>
        </div>
      ...
      {/* footer */}
      {/* <section className="absolute bottom-0 w-full overflow-hidden bg-white py-8">
            ...
            <div className="w-auto p-8">
              <a href="#">
                <div className="inline-flex items-center">
                  ...
                  <span className="ml-4 text-lg font-bold">OGTech</span>
                </div>
              </a>
            </div>
            <div className="w-auto p-8">
